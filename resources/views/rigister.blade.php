    ...
    <div class="wrapper">
        ...
        <div class="registerCon">
            <ul>
                <li class="accAndPwd">
                    <dl>
                        <s class="phone"></s><input id="userMobile" name="rigiter_tel" maxlength="11" type="number" placeholder="请输入您的手机号码" value="" />
                    ...
                    <dl>
                        <s class="password"></s>
                        <input class="conpwd" maxlength="11" type="text"  name="rigister_pwd1" placeholder="请确认密码" value="" />
                        <input class="conpwd" maxlength="11" type="password"  name="rigister_pwd1" placeholder="请确认密码" value="" style="display: none" />
                        <span class="mr clear">x</span>
                        <s class="eyeclose"></s>
                    </dl>
                    <dl class="registerCon">
...
<script>
    ...
    $('#btnNext').click(function(){
    	if($('#userMobile').val()==''){
            ...
            $.get(
                "{{url('rigister/rigisterdo')}}",
                {rigister_tel:$('#userMobile').val(),rigister_pwd:$('.pwd').val()},
                function(res){
                    if(res==1){
